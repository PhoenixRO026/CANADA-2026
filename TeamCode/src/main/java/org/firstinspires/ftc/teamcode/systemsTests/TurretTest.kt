...
class TurretTest : LinearOpMode() {
    ...
    override fun runOpMode() {
        val motorTop = hardwareMap.get(DcMotorEx::class.java, "motorShooterTop")
        val motorBottom = hardwareMap.get(DcMotorEx::class.java, "motorShooterBottom")
        ...
        while (opModeIsActive()) {
            motorTop.power = OuttakeConfig.motorPower
            motorBottom.power = OuttakeConfig.motorPower
